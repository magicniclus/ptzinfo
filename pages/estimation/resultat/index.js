        ...
        <div className="flex lg:flex-row flex-col justify-between mt-10">
          <div className="lg:w-8/12">
            ...
            <p className="mb-4">
              ...
              primo-accédants. Avant de vous lancer dans votre projet
              immobilier, comprenez les conditions d'éligibilité et les plafonds
              de ressources qui s'appliquent :
            </p>
            ...
            <ul className="mb-4 text-gray-500">
              ...
              <li className="mb-2">
                2. Utilisation comme résidence principale : Le bien financé par
                le PTZ doit être utilisé comme résidence principale.
              </li>
            </ul>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Les plafonds de ressources déterminent si vous êtes éligible au
              PTZ. Il prend en compte le total des revenus fiscaux de référence
              de l'année N-2 des personnes qui vont habiter le logement. Pour
              une demande de PTZ faite en 2023, il s'agit du revenu fiscal de
              référence de 2021, inscrit sur l'avis d'imposition de 2022. Si
              vous avez des revenus provenant de l'étranger, ils sont à prendre
              en compte. Ces plafonds varient en fonction de la localisation du
              bien et du nombre de personnes composant le foyer.
            </p>
            <p className="mb-4">
              Tableau - PTZ : montant maximum selon le nombre de personnes
              logées et la zone de la commune
            </p>
            ...
            <p className="mb-4">
              La zone dans laquelle se trouve la ville du bien, associé au
              nombre de personnes logées dans le foyer, détermine à la fois :
            </p>
            <ul className="mb-4 text-gray-500">
              <li className="mb-2">1. Le plafond de ressources à respecter</li>
              <li className="mb-2">
                2. Le montant maximum du prêt à taux zéro.
              </li>
            </ul>

            <p className="mb-4">
              Pour connaître les plafonds de ressources spécifiques à votre
              situation, nous mettons à votre disposition un outil de simulation
              en ligne. Cet outil vous permettra d'estimer rapidement votre
              éligibilité et le montant du PTZ auquel vous pouvez prétendre.
            </p>
            <img
            ...
            <h2 className="text-xl font-bold mb-4 mt-10">
              Prix en TVA réduite : les critères d’éligibilité et les plafonds
              de ressources requis
            </h2>
            <p className="mb-4">
              Si vous envisagez l'achat d'un logement neuf en Zone ANRU ou aux
              abords de ce type de zone, la TVA réduite est une option à
              considérer. Voici ce que vous devez savoir :
            </p>
            <h2 className="text-lg font-bold mb-4 underline">
            ...
            <ul className="mb-4 text-gray-500">
              <li className="mb-2">
                1. Localisation du bien : L'achat en TVA réduite concerne les
                zones couvertes par l'ANRU, souvent sujettes à des projets de
                rénovation urbaine.
              </li>
              <li className="mb-2">
                2. Type de bien : Le bien doit être neuf pour bénéficier de la
                TVA réduite.
              </li>
              <li className="mb-2">
                3. Occupation à titre de résidence principale : Vous devez
            ...
            <p className="mb-4">
              Les plafonds de ressources varient en fonction de la zone (Paris,
              Île de France et autres régions) et du nombre de personnes dans le
              foyer. Notre outil de simulation en ligne prend en compte ces
              facteurs pour vous fournir une estimation complète.
            </p>
            <p className="mb-4">
